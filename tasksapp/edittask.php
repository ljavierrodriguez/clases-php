<?php
    include('./todos/buscar_tarea.php');
?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>Editar Tareas</h3>
                <form action="./todos/editar_tarea.php" method="post">
                    <input type="hidden" name="id" value="<?php echo $tarea[0]; ?>">
                    <div class="form-group mb-3">
                        <label for="task" class="form-label">Tarea</label>
                        <input type="text" class="form-control" id="task" name="task" placeholder="Editar Tarea" value="<?php echo $tarea[1] ?>">
                    </div>
                    <div class="form-group mb-3">
